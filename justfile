...
fix-copyright:
    for f in $(rg -t cpp -t h -t cs -g '!ThirdParty' --files-without-match -F "Copyright 2021 Stream.IO, Inc. All Rights Reserved."); do dos2unix $f; sed -i '1s;^;// Copyright 2021 Stream.IO, Inc. All Rights Reserved.\n\n;' $f; done
