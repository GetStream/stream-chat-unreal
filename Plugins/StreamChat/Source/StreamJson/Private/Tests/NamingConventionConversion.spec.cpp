...
BEGIN_DEFINE_SPEC(FNamingConventionConversionSpec, "StreamChat.NamingConventionConversion",
	EAutomationTestFlags::ProductFilter | EAutomationTestFlags::ApplicationContextMask)
END_DEFINE_SPEC(FNamingConventionConversionSpec)

void FNamingConventionConversionSpec::Define()
{
	It("should convert snake_case to UpperCamelCase", EAsyncExecution::ThreadPool,
		[this]()
		{
	...
	It("should convert mixed-up snake_case to UpperCamelCase", EAsyncExecution::ThreadPool,
		[this]()
		{
